...
if ! command -v python3 &> /dev/null; then
    echo "❌ Python 3 não encontrado. Por favor instale Python 3.7+ primeiro."
...
python3 --version || (echo "❌ Erro ao verificar Python" && exit 1)

echo "📦 Instalando dependências Python..."
$PIP_CMD install rich typer jinja2 || (echo "❌ Erro ao instalar dependências" && exit 1)
